...
object DrawableUtils {
    ...
    fun getShieldYellow2() = R.drawable.ic_shield_yellow_2
    fun getShieldYellow3() = R.drawable.ic_shield_yellow_3
    fun getShieldYellow4() = R.drawable.ic_shield_yellow_4
    fun getShieldYellow5() = R.drawable.ic_shield_yellow_5
    fun getShieldWhite1() = R.drawable.ic_shield_white_1
    fun getShieldWhite2() = R.drawable.ic_shield_white_2
    fun getShieldWhite3() = R.drawable.ic_shield_white_3
    fun getShieldWhite4() = R.drawable.ic_shield_white_4
    fun getShieldWhite5() = R.drawable.ic_shield_white_5
    fun getShieldBlue1() = R.drawable.ic_shield_blue_1
    fun getShieldBlue2() = R.drawable.ic_shield_blue_2
    fun getShieldBlue3() = R.drawable.ic_shield_blue_3
    fun getShieldBlue4() =  R.drawable.ic_shield_blue_4
    ...
    fun getTitleText1() = R.id.titleText1
    fun getTitleText2() = R.id.titleText2
    fun getTitleAudio() = R.id.titleAudio
    fun getText1() = R.id.text_1
    fun getText2() = R.id.text_2
    fun getAudio() = R.id.audio
    fun getStatusLesson1() = R.id.status_lesson_1
    fun getStatusLesson2() = R.id.status_lesson_2
    fun getStatusLesson3() = R.id.status_lesson_3
    fun getTextRoute() = R.id.text_route
    fun getImgRoute() = R.id.img_route
    fun getRelativeLayout() = R.id.relative_layout
    fun getRvStops() = R.id.rvStops
